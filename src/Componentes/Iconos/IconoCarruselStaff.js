...
function TipoRespuesta(props) {
  ...
  export default function Icono(props) {
    ...
    return (
        <svg  fill={props.color} width={props.size} height="auto" version="1.1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" space="preserve">
            {TipoRespuesta(props)}    
        </svg>
